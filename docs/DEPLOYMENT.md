# DataGenie AI - Deployment Guide

This guide covers deploying DataGenie AI using a hybrid approach combining your local machine with Azure cloud services.
...
**Memory Note**: llama3.2:3b variant uses ~2GB RAM.
